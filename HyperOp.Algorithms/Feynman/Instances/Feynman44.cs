namespace HyperOp.Algorithms.Feynman.Instances
{
    public class Feynman44 : FeynmanDescriptor
    {
        ...
        public override string TargetVariable { get { return noiseRatio == null ? "L_rad" : "L_rad_noise"; } }
        ...
        public override string[] AllowedInputVariables { get { return new[] { "omega", "T", "h", "kb", "c" }; } }
