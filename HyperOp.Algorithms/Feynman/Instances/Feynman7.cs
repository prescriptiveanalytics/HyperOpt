namespace HyperOp.Algorithms.Feynman.Instances
{
    public class Feynman7 : FeynmanDescriptor
    {
        ...
        public override string TargetVariable { get { return noiseRatio == null ? "A" : "A_noise"; } }
        ...
        public override string[] AllowedInputVariables { get { return new[] { "x1", "x2", "x3", "y1", "y2", "y3" }; } }
