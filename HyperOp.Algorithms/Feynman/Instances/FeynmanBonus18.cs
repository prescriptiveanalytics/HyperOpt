namespace HyperOp.Algorithms.Feynman.Instances
{
    public class FeynmanBonus18 : FeynmanDescriptor
    {
        ...
        public override string TargetVariable { get { return noiseRatio == null ? "rho_0" : "rho_0_noise"; } }
        ...
        public override string[] AllowedInputVariables { get { return new[] { "G", "k_f", "r", "H_G", "c" }; } }
