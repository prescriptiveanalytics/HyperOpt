namespace HyperOp.Algorithms.Feynman.Instances
{
    public class Feynman45 : FeynmanDescriptor
    {
        ...
        public override string TargetVariable { get { return noiseRatio == null ? "v" : "v_noise"; } }
        ...
        public override string[] AllowedInputVariables { get { return new[] { "mu_drift", "q", "Volt", "d" }; } }
