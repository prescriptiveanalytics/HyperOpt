namespace HyperOp.Algorithms.Feynman.Instances
{
    public class Feynman36 : FeynmanDescriptor
    {
        ...
        public override string TargetVariable { get { return noiseRatio == null ? "omega" : "omega_noise"; } }
        ...
        public override string[] AllowedInputVariables { get { return new[] { "c", "v", "omega_0" }; } }
