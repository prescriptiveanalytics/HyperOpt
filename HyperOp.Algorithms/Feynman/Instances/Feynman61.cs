namespace HyperOp.Algorithms.Feynman.Instances
{
    public class Feynman61 : FeynmanDescriptor
    {
        ...
        public override string TargetVariable { get { return noiseRatio == null ? "x" : "x_noise"; } }
        ...
        public override string[] AllowedInputVariables { get { return new[] { "q", "Ef", "m", "omega_0", "omega" }; } }
