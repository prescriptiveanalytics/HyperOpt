namespace HyperOp.Algorithms.Feynman.Instances
{
    public class FeynmanBonus13 : FeynmanDescriptor
    {
        ...
        public override string TargetVariable { get { return noiseRatio == null ? "E_n" : "E_n_noise"; } }
        ...
        public override string[] AllowedInputVariables { get { return new[] { "m", "omega", "p", "y", "x", "alpha" }; } }
