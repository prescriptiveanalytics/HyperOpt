namespace HyperOp.Algorithms.Feynman.Instances
{
    public class Feynman73 : FeynmanDescriptor
    {
        ...
        public override string TargetVariable { get { return noiseRatio == null ? "flux" : "flux_noise"; } }
        ...
        public override string[] AllowedInputVariables { get { return new[] { "epsilon", "c", "Ef" }; } }
