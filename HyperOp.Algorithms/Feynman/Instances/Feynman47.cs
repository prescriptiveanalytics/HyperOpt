namespace HyperOp.Algorithms.Feynman.Instances
{
    public class Feynman47 : FeynmanDescriptor
    {
        ...
        public override string TargetVariable { get { return noiseRatio == null ? "kappa" : "kappa_noise"; } }
        ...
        public override string[] AllowedInputVariables { get { return new[] { "gamma", "kb", "A", "v" }; } }
