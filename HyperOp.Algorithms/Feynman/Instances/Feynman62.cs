namespace HyperOp.Algorithms.Feynman.Instances
{
    public class Feynman62 : FeynmanDescriptor
    {
        ...
        public override string TargetVariable { get { return noiseRatio == null ? "n" : "n_noise"; } }
        ...
        public override string[] AllowedInputVariables { get { return new[] { "n_0", "kb", "T", "theta", "p_d", "Ef" }; } }
