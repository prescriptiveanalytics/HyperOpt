namespace HyperOp.Algorithms.Feynman.Instances
{
    public class Feynman64 : FeynmanDescriptor
    {
        ...
        public override string TargetVariable { get { return noiseRatio == null ? "Pol" : "Pol_noise"; } }
        ...
        public override string[] AllowedInputVariables { get { return new[] { "n", "alpha", "epsilon", "Ef" }; } }
