namespace HyperOp.Algorithms.Feynman.Instances
{
    public class Feynman60 : FeynmanDescriptor
    {
        ...
        public override string TargetVariable { get { return noiseRatio == null ? "Ef" : "Ef_noise"; } }
        ...
        public override string[] AllowedInputVariables { get { return new[] { "sigma_den", "epsilon", "chi" }; } }
