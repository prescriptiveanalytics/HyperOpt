namespace HyperOp.Algorithms.Feynman.Instances
{
    public class Feynman52 : FeynmanDescriptor
    {
        ...
        public override string TargetVariable { get { return noiseRatio == null ? "Pwr" : "Pwr_noise"; } }
        ...
        public override string[] AllowedInputVariables { get { return new[] { "kappa", "T1", "T2", "A", "d" }; } }
