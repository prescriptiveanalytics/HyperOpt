namespace HyperOp.Algorithms.Feynman.Instances
{
    public class FeynmanBonus5 : FeynmanDescriptor
    {
        ...
        public override string TargetVariable { get { return noiseRatio == null ? "theta1" : "theta1_noise"; } }
        ...
        public override string[] AllowedInputVariables { get { return new[] { "c", "v", "theta2" }; } }
